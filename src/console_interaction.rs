...
pub fn print_help() {
    let rows: Vec<CommandsRow> = vec![
        ...
        CommandsRow{ id: 7, command_name: "getPerson".to_string(), parameter_1: "<group name>".to_string(), parameter_2: "      -     ".to_string(), description: "Each user gets the name of another user to whom he needs to give a gift".to_string()},
        CommandsRow{ id: 8, command_name: "getUsers".to_string(), parameter_1: "     -     ".to_string(), parameter_2: "      -     ".to_string(), description: "Each user can get list with users".to_string()},
        CommandsRow{ id: 9, command_name: "getGroups".to_string(), parameter_1: "     -     ".to_string(), parameter_2: "      -     ".to_string(), description: "Each user can get list with groups".to_string()},
